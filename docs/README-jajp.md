...
- FAQ
  - [なぜJavaScript Standard Styleを使用するのですか？](#なぜJavaScript-Standard-Styleを使用するのですか)
  - [JavaScript Standard Styleを使うのはどのような人ですか？](#JavaScript-Standard-Styleを使うのはどのような人ですか)
  ...
  - [実験版JavaScript(ES Next)の新機能はどのように使用しますか？](#実験版JavaScript-ES-Nextの新機能はどのように使用しますか)
  ...
  - [`standard`にコントリビュートするにはどうすればいいですか？](#standardにコントリビュートするにはどうすればいいですか)
- [ライセンス](#ライセンス)
